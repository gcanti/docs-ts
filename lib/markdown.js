...
function printModule(module, counter) {
    ...
    var md = module.interfaces.map(function (i) { return printInterface(i); }).join('') +
    ...
    var result = header + printModuleDescription(module.description) + bold('Table of contents') + CRLF + toc(md).content + md;
