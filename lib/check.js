...
var context = { exports: {}, require: require };
...
function check(sources, options) {
    ...
    return Array_1.catOptions(Object.keys(sources).map(function (k) {
        var code = transpile(sources[k], options);
        return evaluate(code).map(function (e) { return k + ": " + String(e); });
    }));
}
exports.check = check;
